  ...
  return (
    <>
      <div className="fixed bottom-0 md:bottom-2 left-0 md:left-1/2 md:-translate-x-1/2 z-50 w-full md:w-auto">
        <div className="md:bg-white/30 md:macos-blur md:macos-dock-shadow md:rounded-2xl md:px-2 md:py-2 bg-white/40 backdrop-blur-xl border-t border-white/20 md:border md:border-white/20 overflow-x-auto overflow-y-hidden scrollbar-hide">
